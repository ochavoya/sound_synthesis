...
#define BJUST	((double)  243/128)	//B
	...
	#else
		#define CSHARP	((double)338/315)
		#define DFLAT 	((double)338/315)
		#define DBEMOL	((double)147/130)	
		#define DJUST  	((double)15/13)  	//D
		#define DSHARP 	((double)91/75)
		#define EFLAT	((double)91/75) 	// Eb
		#define EJUST 	((double)26/21)  	// E
		#define FJUST 	((double)225/169)  	// F
		#define FSHARP 	((double) 7/5)	// 
		#define GFLAT	((double) 10/7) // 
		#define GJUST 	((double)338/225)	//G
		#define GSHARP	((double)21/13)	
		#define AFLAT	((double)21/13)
		#define AJUST 	((double)150/91)	//A
		#define ASHARP 	((double)16/15)
		#define BFLAT 	((double)260/145)
		#define BJUST 	((double)315/169)	//B
	#endif
#endif
...
Tone *makeTone(double (*wave)(double x),double freq,int octave,double duration,double azimuth){
	...
	double equalization = 132 / sqrt(freq);
	...
	if(tone->left == NULL || tone->left == NULL ){
		memoryError();
	}
